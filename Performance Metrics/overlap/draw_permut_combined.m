fig_title = 'overlap based on the hidden states';
...
% ci_upper = ones(1,length(thickLabels))*ci(2,:);
% 
% plot(0.5 :length(thickLabels),precoss_mean, 'r', 'LineWidth', 1.25)
% plot(0.5 :length(thickLabels),ci_lower, '-.r')
% plot(0.5 :length(thickLabels),ci_upper, '-.r')
